...
# Source: third-party/psat/tests\d_kundur1_svc_mdl.m  (upstream PSAT, GPL-2.0+)
...
Line.con = [ ... 
  ...
  9  8  100  230  60  0  0  0.011  0.11  0.09625  0  0  1  0  0  1
...
PV.con = [ ... 
  ...
  8  100  230  0  1.03  5  -2  1.1  0.9  1  1
...
Exc.con = [ ... 
  1  2  5  -5  20  0.055  0.125  1.8  1  0.36  0.05  0.0056  1.075
  2  2  5  -5  20  0.055  0.125  1.8  1  0.36  0.05  0.0056  1.075
  4  2  5  -5  20  0.055  0.125  1.8  1  0.36  0.05  0.0056  1.075
  3  2  5  -5  20  0.055  0.125  1.8  1  0.36  0.05  0.0056  1.075
 ]

#Svc.con = [ ... 
#  8  100  230  60  1  0.02  10  1  2  -0.2  0.001  0  1  0.01  0.2  0.1  1;
# ];

#Pod.con = [ ... 
#  10  1  1  1  0.2  -0.2  0.1  5  0.4  0.2  0.4  0.2  0.001;
# ];
