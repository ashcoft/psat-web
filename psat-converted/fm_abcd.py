...
# Source: third-party/psat/fm_abcd.m  (upstream PSAT, GPL-2.0+)
...
if not DAE.n
  ...
  fm_print('Computation of linear dynamic matrices aborted.')
  return

fm_print('Computation of input/output matrices A,B,C,D:')
fm_disp
fm_print('[Delta dx/dt] = [A] [Delta x] + [B] [Delta u]')
fm_print('    [Delta y] = [C] [Delta x] + [D] [Delta u]')
fm_disp
fm_print('These matrices are stored in structure LA.')
...
fm_print('Computation of input/output matrices completed.')