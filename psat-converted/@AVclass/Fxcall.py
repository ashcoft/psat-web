...
# Source: third-party/psat/@AVclass\Fxcall.m  (upstream PSAT, GPL-2.0+)
...
if ty3
  ...
  DAE.Fy = DAE.Fy + sparse(p.vf(ty3),p.vbus(ty3),w.*z.*(vr3+Kr1.*(vref-vm)+vf0)./(v0+(not w))./Te(ty3),DAE.n,DAE.m)
