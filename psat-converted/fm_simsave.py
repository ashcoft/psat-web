...
# Source: third-party/psat/fm_simsave.m  (upstream PSAT, GPL-2.0+)
# WARNING: This is a mechanical, BEST-EFFORT textual conversion.
# It is NOT a runnable Python port. Manual review is REQUIRED.
# ------------------------------------------------------------------
def fm_simsave(varargin):
...
switch nargin
 ...
 case 1,
  if not strcmp(varargin{1},'all'), return, end
...
fm_print(['Model ', modelname,' will be saved in Simulink 5.1 (R13SP1) format.'])
