...
# Source: third-party/psat/@FCclass\Fxcall.m  (upstream PSAT, GPL-2.0+)
...
Ik = DAE.x(a.Ik)
Vk = DAE.x(a.Vk) + (not a.u)
Vs = DAE.y(a.vbus)
pH2 = DAE.x(a.pH2) + (not a.u)
pH2O = DAE.x(a.pH2O) + (not a.u)
pO2 = DAE.x(a.pO2) + (not a.u)
qH2 = DAE.x(a.qH2)
m = DAE.x(a.m)
Sn = a.con(:,2)
Vn = a.con(:,3)
