...
# Source: third-party/psat/fm_setting.m  (upstream PSAT, GPL-2.0+)
  ...
  switch varargin{1}
   case 'tstep'
    ...
    if isempty(str2num(get(gcbo,'String')))
      ...
      fm_print('Time step cannot be empty.',2)
    else
      ...
      if Settings.tstep == 0
        ...
        set(gcbo,'String',num2str(Settings.tstep))
        fm_print('Time step cannot be zero.',2)
      elseif Settings.tstep < 0
        Settings.tstep = oldtstep
        set(gcbo,'String',num2str(Settings.tstep))
        fm_print('Time step cannot be negative.',2)
      fm_print(['Time step set to ',num2str(Settings.tstep),' s'])

   case 'deltadelta'

    if isempty(str2num(get(gcbo,'String')))
      set(gcbo,'String',num2str(Settings.deltadelta))
      fm_print('Max delta diff. cannot be empty.',2)
    else
      ...
      if Settings.deltadelta == 0
        ...
        set(gcbo,'String',num2str(Settings.deltadelta))
        fm_print('Max delta diff. cannot be zero.',2)
      elseif Settings.deltadelta < 0
        Settings.deltadelta = olddiff
        set(gcbo,'String',num2str(Settings.deltadelta))
        fm_print('Max delta diff. cannot be negative.',2)
      fm_print(['Max delta diff. set to ',num2str(Settings.deltadelta),' s'])
   ...
   case 'forcepq'
    ...
    if Settings.pq2z
      ...
      set(hdl,'Value',0)
      Settings.pq2z = 0
      if not Settings.pq2z  and  Settings.init
        global PQ
        PQ = noshunt(PQ)
        fm_call('i')
...
if Settings.pq2z  and  Settings.forcepq
  set(h1,'Value',0)
  Settings.forcepq = 0
h1 = uicontrol('Parent',h0, ...
               'Units', 'normalized', ...
