...
# Source: third-party/psat/fm_advanced.m  (upstream PSAT, GPL-2.0+)
  ...
  switch varargin{1}
   case 'iternum'
    ...
    if isempty(str2num(get(gcbo,'String')))
      ...
      fm_print('The iteration number cannot be empty.',2)
    else
      Settings.pv2pqniter = round(str2num(get(gcbo,'String')))
      fm_print(['Iteration number set to ',num2str(Settings.pv2pqniter)])
