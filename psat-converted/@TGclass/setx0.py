...
# Source: third-party/psat/@TGclass\setx0.m  (upstream PSAT, GPL-2.0+)
...
if a.ty3
  ...
  a.dat3 = [a.tg1(a.ty3), ...             #   1
            ...
            np.zeros((len(a.ty3),1), ...   #  18)
            np.zeros((len(a.ty3),1)];      #  19)
...
if a.ty4
  ...
  a.dat4 = [a.tg1(a.ty4), ...             #   1
            ...
            np.zeros((len(a.ty4),1), ...   #  21)
            np.zeros((len(a.ty4),1)];      #  22)
...
if a.ty5
  ...
  a.dat5 = [a.tg1(a.ty5), ...             #   1
            ...
            np.zeros((len(a.ty5),1), ...   #  13)
            np.zeros((len(a.ty5),1)];      #  14)
...
#   K3 = (Gmax-Gmin).*Settings.mva./getvar(Syn,a.syn(a.ty6),'mva');
  ...
  a.dat6 = [a.tg1(a.ty6), ...             #   1
            ...
            np.zeros((len(a.ty6),1), ...   #  19)
            np.zeros((len(a.ty6),1), ...  #  20)
...
for i in range(1, len(maxlmt)+1):
  fm_print(['Pmech greater than maximum limit for TG #', ...
           num2str(maxlmt(i))],1)
for i in range(1, len(minlmt)+1):
  fm_print(['Pmech less than minimum limit for TG #', ...
           num2str(minlmt(i))],1)
if isempty(maxlmt)  and  isempty(minlmt)
  fm_print('Initialization of Turbine Gorvernors completed.',1)
else
  fm_print('Initialization of Turbine Gorvernors failed.',2)
  return
