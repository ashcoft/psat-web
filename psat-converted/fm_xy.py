...
# Source: third-party/psat/fm_xy.m  (upstream PSAT, GPL-2.0+)
...
if not Line.n
  fm_print('No static network is loaded. Network tree cannot be drawn.',1)
  return

if not Bus.n
  fm_print('No data is loaded. Network tree cannot be drawn.',1)
  return
