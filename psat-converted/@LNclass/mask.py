...
# Source: third-party/psat/@LNclass\mask.m  (upstream PSAT, GPL-2.0+)
# WARNING: This is a mechanical, BEST-EFFORT textual conversion.
# It is NOT a runnable Python port. Manual review is REQUIRED.
# ------------------------------------------------------------------
function [x,y,s] = mask(a,idx,orient,descr)

if not isempty(strfind(descr,'auto'))
...
elseif not isempty(strfind(descr,'former'))

  tap = not isempty(strfind(descr,'ratio'))
  phs = not isempty(strfind(descr,'shifter'))
...
elseif not isempty(strfind(descr,'line'))
...
elseif not isempty(strfind(descr,'cable'))
