...
# Source: third-party/psat/@SYclass\Fxcall.m  (upstream PSAT, GPL-2.0+)
...
# common Jacobians
DAE.Fx = DAE.Fx - sparse(a.delta,a.delta,(not a.u),DAE.n,DAE.n)
DAE.Fx = DAE.Fx + sparse(a.delta,a.omega,Wn,DAE.n,DAE.n)
DAE.Fx = DAE.Fx - sparse(a.omega,a.omega,iM.*D+(not a.u),DAE.n,DAE.n)
...
if (not isempty(is3))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q3,e1q3,a34.*synsat(a,2,e1q(is3),is3)+a35.*a.c3(is3)+(not a.u(is3)),DAE.n,DAE.n)
...
if not isempty(is4)
  ...
  DAE.Fx = DAE.Fx - sparse(e1q4,e1q4,a44.*synsat(a,2,e1q(is4),is4)+a45.*a.c3(is4)+(not a.u(is4)), DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e1d4,e1d4,b43+b44.*a.c2(is4)+(not a.u(is4)), DAE.n,DAE.n)
...
if(not isempty(is51))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q51,e1q51,a514.*synsat(a,2,e1q(is51),is51)+a515.*a.c3(is51)+(not a.u(is51)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e1d51,e1d51,b513+(not a.u(is51)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e2d51,e2d51,b511+b512.*a.c2(is51)+(not a.u(is51)),DAE.n,DAE.n)
...
if(not isempty(is52))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q52,e1q52,a524.*synsat(a,2,e1q(is52),is52)+(not a.u(is52)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e2q52,e2q52,a521+a522.*a.c3(is52)+(not a.u(is52)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e2d52,e2d52,b521+b522.*a.c2(is52)+(not a.u(is52)),DAE.n,DAE.n)
...
if (not isempty(is53))
  ...
  DAE.Fx = DAE.Fx + sparse(e1q53,e1q53,q3-(not a.u(is53)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(psiq53,psiq53,Wn.*ra(is53).*c535+(not a.u(is53)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(psid53,psid53,Wn.*ra(is53).*c534+(not a.u(is53)),DAE.n,DAE.n)
...
if(not isempty(is6))
  ...
  DAE.Fx = DAE.Fx - sparse(e1q6,e1q6,a4.*synsat(a,2,e1q(is6),is6)+(not a.u(is6)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e1d6,e1d6,b3+(not a.u(is6)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e2q6,e2q6,a1+a2.*a.c3(is6)+(not a.u(is6)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e2d6,e2d6,b1+b2.*a.c2(is6)+(not a.u(is6)),DAE.n,DAE.n)
...
if not isempty(is8)
  ...
  DAE.Fx = DAE.Fx - sparse(e1q8,e1q8,a48.*synsat(a,2,e1q(is8),is8)+(not a.u(is8)),DAE.n,DAE.n)
  DAE.Fx = DAE.Fx - sparse(e1q8,e2q8,a58./xd2(is8),DAE.n,DAE.n)
  DAE.Fx = DAE.Fx + sparse(e1q8,psid8,a58./xd2(is8),DAE.n,DAE.n)
  
  DAE.Fx = DAE.Fx - sparse(e1d8,e1d8,b38+(not a.u(is8)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(e2q8,e2q8,a18+a28./xd2(is8)+(not a.u(is8)),DAE.n,DAE.n)
  DAE.Fx = DAE.Fx + sparse(e2q8,psid8,a28./xd2(is8),DAE.n,DAE.n)
  
  DAE.Fx = DAE.Fx + sparse(e2d8,e1d8,b18,DAE.n,DAE.n)
  DAE.Fx = DAE.Fx - sparse(e2d8,e2d8,b18+b28./xq2(is8)+(not a.u(is8)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(psiq8,psiq8,Wn.*ra(is8)./xq2(is8)+(not a.u(is8)),DAE.n,DAE.n)
  ...
  DAE.Fx = DAE.Fx - sparse(psid8,psid8,Wn.*ra(is8)./xd2(is8)+(not a.u(is8)),DAE.n,DAE.n)
