...
# Source: third-party/psat/fm_bar.m  (upstream PSAT, GPL-2.0+)
...
if not ishandle(Fig.main), return, end
...
switch command
 case 'open'
  ...
  if Settings.hostver < 8.04  and  Settings.hostver > 8
    set(p1,'HorizontalAlignment','left')
    set(p2,'HorizontalAlignment','left')
  elseif Settings.hostver >= 7.07  and  Settings.hostver < 8
