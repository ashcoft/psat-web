...
# Source: third-party/psat/fm_component.m  (upstream PSAT, GPL-2.0+)
...
if nargin
  if not exist('Fig'), Fig.comp = -1, end
  ...
  switch varargin{1}
   ...
   case 'cbdown'
    ...
    if pos(1) > 0.100  and  pos(2) > 0.083  and  pos(1) < 0.447  and  pos(2) < 0.375
