...
# Source: third-party/psat/@PLclass\setx0.m  (upstream PSAT, GPL-2.0+)
...
for j in range(1, len(i)+1):
  ...
  if isempty(idx)
    fm_print(['No PQ load found for initializing ZIP load ', ...
...
fm_print('Initialization of ZIP loads completed.')
