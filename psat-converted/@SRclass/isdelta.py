...
# Source: third-party/psat/@SRclass\isdelta.m  (upstream PSAT, GPL-2.0+)
...
if Settings.hostver > 7
  ...
  out5 = not isempty(find(a.delta == idx,1))
else
  ...
  out5 = not isempty(find(a.delta == idx))

out = out1  or  out2  or  out3  or  out4  or  out5
