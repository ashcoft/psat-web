...
# Source: third-party/psat/fm_about.m  (upstream PSAT, GPL-2.0+)
...
if nargin
  ...
  if not exist('Fig'), Fig.about = -1; end
  if not ishandle(Fig.about)
...
for i in range(1, len(h)+1):
      ...
      if pos(1) > ph1  and  pos(2) > ph2   and  pos(1) < ph3  and  pos(2) < ph4
        switch i
  ...
  case 'aboutmove'
    ...
    if pos(1) > 0.3  and  pos(1) < 0.9
for i in range(1, len(h)+1):
        ph2 = ph{i}(2)
        ph4 = ph{i}(2) + ph{i}(4)
        if pos(2) > ph2  and  pos(2) < ph4
