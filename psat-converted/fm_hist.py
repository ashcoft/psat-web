...
# Source: third-party/psat/fm_hist.m  (upstream PSAT, GPL-2.0+)
...
n = fix(len(c)/25)+sign(rem(len(c),25))

for j in range(1, n+1):
  for i = 1:min(25,len(c)-25*(j-1))
  ...
  if len(c)-25*(j-1) > 25, h3 = uimenu('Parent',h2,'Label','more ...','Tag',tb); end
  h2 = h3
